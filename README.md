...
- **Generative AI & Agentic Workflows** 🧠: Multi-agent systems (LangGraph, CrewAI), RAG pipelines, LLM fine-tuning, and MCP.
...
- **Cloud AI (AWS · Azure · GCP)** ☁️: Production deployments of scalable AI solutions across all major cloud platforms.
- **Data Engineering** 🔧: Real-time pipelines with Apache Kafka, Flink, and Druid.
...
<a href="https://dvc.org/" target="_blank"><img src="https://cdn.simpleicons.org/dvc/945DD6" alt="dvc" width="40" height="40"/></a>
<a href="https://min.io/" target="_blank"><img src="https://cdn.simpleicons.org/minio/C72E49" alt="minio" width="40" height="40"/></a>
<a href="https://github.com/features/actions" target="_blank"><img src="https://cdn.simpleicons.org/githubactions/2088FF" alt="github-actions" width="40" height="40"/></a>
...
<a href="https://openai.com/" target="_blank"><img src="https://cdn.brandfetch.io/idR3duQxYl/theme/dark/logo.svg?c=1bxid64Mup7aczewSAYMX&t=1741166761458" alt="openai" width="40" height="40"/></a>
<a href="https://chatgpt.com/" target="_blank"><img src="https://cdn.brandfetch.io/id2UDPob7G/theme/dark/logo.svg?c=1bxid64Mup7aczewSAYMX&t=1754282172596" alt="chatgpt" width="40" height="40"/></a>
<a href="https://groq.com/" target="_blank"><img src="https://cdn.brandfetch.io/idxygbEPCQ/theme/dark/logo.svg?c=1bxid64Mup7aczewSAYMX&t=1667583814625" alt="groq" width="40" height="40"/></a>
...
|---|---|---|
| **Internal RAG Agent System** | Vertex AI, Google ADK, MCP, Memory Bank | Multi-agent RAG with dual memory (short/long-term), SharePoint & Coveo integration |
| **Video Analytics AI Server** | YOLO11, gRPC, PyTorch, OpenCV, CUDA | 11+ CV use cases · 98%+ accuracy · sub-second latency · bidirectional gRPC streaming |
| **KINECTIFY — GenAI Reporting** | Azure AI Studio, LangChain, RAG, CosmosDB, MLFlow | LLM evaluation pipeline for financial compliance (GPT-4o, Llama-2, FLAN-T5) |
| **MSIL — Number Plate Detection** | YOLO11, SageMaker, FastAPI, AWS | 3000–4000 req/min · auto-scaling endpoint · real-time vehicle classification · Jan 2025–Present |
| **VCOACH — Pharma Sales Training** | FastAPI, Azure OpenAI GPT-4o, LangChain | Multilingual AI doctor personas · compliance monitoring · certification pipeline · May–Jun 2025 |
| **SIFTSALES — Sales Analytics Bot** | LangGraph, Azure OpenAI, FastAPI, Plotly | NL-to-SQL multi-agent chatbot · interactive visualizations · Aug 2024–Mar 2025 |

### 🎙️ Community Lectures

| Title | Platform | Date |
|---|---|---|
| [FastAPI for AI Application](https://www.youtube.com/c17hawke) | YouTube Playlist | Sep 2024 |
| [How to create well-tested Python packages](https://www.youtube.com/c17hawke) | YouTube Playlist | Sep 2022 |
